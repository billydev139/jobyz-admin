  ...
  const getAllInquiries = async () => {
    ...
    try {
      const response = await api.get(
        `https://api.jobyz.ch/api/contact/job?page=${currentStep}&search=${searchQuery}`
      );
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-800">
                    {selectedItem?.salutation} {selectedItem?.firstName}{" "}
      ...
      <div className="rounded-sm border border-stroke bg-white  pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark  xl:pb-1">
        <div className="max-w-full overflow-x-auto">
          {loading ? (
                  ...
                  <tr key={key}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark space-x-2">
                      <button
                        ...
                        className="border px-4 py-1 border-[#1967D2] bg-[#1967D2] text-white rounded-md"
                      >
                        View
                      </button>
                      <button
            ...
            <p className="text-center py-20 text-3xl font-semibold">
              No Result Found
            </p>
          )}
        </div>
